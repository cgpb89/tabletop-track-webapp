...
import Input                    from "../Views/Components/Forms/Input";
...
@observer
class LoginViewModel extends React.Component<LoginViewModelProps, any> {

    public constructor(props: LoginViewModelProps) {
        super(props);
    }
